...
const navSections: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      {
        label: "Vancouver Home evaluation",
        href: "/sell/vancouver-home-evaluation",
      },
      {
        label: "Vancouver, BC Sales by owner",
        href: "/sell/vancouver-bc-sales-by-owner",
      },
      { label: "Get started Today", href: "/sell/get-started-today" },
      {
        label: "how to sell a home fast",
        href: "/sell/how-to-sell-a-home-fast",
      },
      { label: "Seller's guide", href: "/sell/sellers-guide" },
      {
        label: "British columbia tax assesment",
        href: "/sell/british-columbia-tax-assesment",
      },
    ],
  },
  {
    label: "Blog",
    items: [
      { label: "Market Update videos", href: "/blog/market-update-videos" },
    ],
  },
];
